...
def get_args_train():
    ...
    parser.add_argument('--hyp', type=str, default='./config/data/hyp.scratch.yaml',
...
def get_args_test():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='EMA_yolov3_300.ckpt', help='model.pt path    (s)')
    ...
    parser.add_argument('--save-json', action='store_true', help='save a cocoapi-compatible JSON results fil    e')
    parser.add_argument('--project', default='./run_test', help='save to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment'    )
    parser.add_argument('--no-trace', action='store_true', help='don`t trace model')
    parser.add_argument('--v5-metric', action='store_true', help='assume maximum recall as 1.0 in AP calcula    tion')
    opt = parser.parse_args()
    return opt
